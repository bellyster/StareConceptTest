...
This project excecute a back end running in the port 3000 and a front end running in the Port 1234. The Aplication is avaliable in: LocalHost:1234/index.html. 
Currently this is using my own Google Custom Json API key, please replace it with your own.
